...
import com.lousseief.vault.service.CryptoService
...
class AddCredentialDialog(evaluator: (String, ActionEvent) -> Unit, header: String): Dialog<String?>() {
    ...
    val passwordLengthProperty = SimpleIntegerProperty(20)
                    ...
                    hbox {
                        ...
                        field("Length:", Orientation.HORIZONTAL) {
                            ...
                            hbox {
                                ...
                                alignment = Pos.CENTER_LEFT
                                vgrow = Priority.ALWAYS
                                spinner(5, 40, 20, 1, true, passwordLengthProperty) {
                                    maxWidth = 80.0
                                    prefWidth = 80.0
                                    intSpinner = this
                                }
